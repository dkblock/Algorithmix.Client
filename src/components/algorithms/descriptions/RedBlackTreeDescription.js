            ...
            <div className="description-container">
                <div className="col-8">
                    <div className="description-paragraph">
                        ...
                        гарантирующих логарифмический рост высоты дерева от числа узлов и позволяющих быстро выполнять
        ...
        <div>
            ...
            <div className="description-container">
                <div className="col-8">
                    ...
                    <div className="description-paragraph">
                        Все листья красно-чёрного дерева являются фиктивными и не содержат данных, но относятся к дереву
                        и являются чёрными.
                    ...
                    <div className="description-paragraph">
                        ...
                        листу.
                        В соответствии со свойством 5 красно-чёрных деревьев, чёрная высота узла – точно определяемое
                        значение.<br/>
                        <b>Чёрная высота дерева</b> - чёрная высота его корня. Чёрная высота дерева на примере равняется
                        1.
                    </div>
                    <div className="description-paragraph">
                        Высота в красно-чёрном дереве ограничена логарифмически. Доказано, что красно-чёрное дерево с N
        ...
        <div>
            ...
            <div className="description-container">
                <div className="col-12">
                    <div className="description-paragraph">
                        ...
                        происходит изменения структуры дерева, из-за чего могут нарушаться его красно-чёрные свойства.
                        Для восстановления этих
                        свойств необходимо изменить цвета некоторых узлов дерева, а также структуру их указателей. При
            ...
            <div className="description-container">
                <div className="col-6">
                    ...
                    <div className="description-paragraph">
                        Вставка нового узла в красно-чёрное дерево происходит так, как если бы это было обычное бинарное
                        дерево поиска,
                        а затем этот узел окрашивается в красный цвет. Но если в бинарном дереве поиска всегда
                        добавляется лист, то в
                        красно-чёрном дереве листья не содержат данных, поэтому добавляется красный внутренний узел с
